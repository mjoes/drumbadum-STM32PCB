...
#define MODE_SELECT_BTN_Pin GPIO_PIN_6
#define MODE_SELECT_BTN_GPIO_Port GPIOB
#define MODE_SELECT_BTN_EXTI_IRQn EXTI9_5_IRQn
#define MODE_SELECT_LED_Pin GPIO_PIN_7
#define MODE_SELECT_LED_GPIO_Port GPIOB
